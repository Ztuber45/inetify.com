...
const randomModeButton = document.querySelector<HTMLButtonElement>("#random-mode-button")!;
const playButton = document.querySelector<HTMLButtonElement>("#play-button")!;
const songAudio = document.querySelector<HTMLAudioElement>("#song")!;
const songCurrentTime = document.querySelector<HTMLSpanElement>("#song-current-time")!;
const songDurationTime = document.querySelector<HTMLSpanElement>("#song-duration-time")!;
const editPlaylistButton = document.querySelector<HTMLButtonElement>("#edit-playlist")!;

let currentSong = songs[0];

const lastElementOfArray = (arr: any[]): any => arr[arr.length - 1];
